 ...
 * @LastEditTime: 2024-12-22 18:41:46
...
// 引入控制器的地方
const {add,DelArticle,UpdateArticle,getArtTabList,getTabTitle} = require('../controller/article.controller.js');
...
router.post('/add',add);
router.get('/getarttablist',getArtTabList)
router.post('/gettabtitle',getTabTitle)
